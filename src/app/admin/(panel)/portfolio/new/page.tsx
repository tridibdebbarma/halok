...
export default function NewPortfolioPage() {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        setIsSaving(true);
        try {
            const galleryArray = values.galleryUrls?.map(g => g.url) || [];
    ...
    return (
        <div className="p-6 pb-20 max-w-5xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-[#1E3A5F]">Add New Project</h1>
                    <p className="text-slate-500 mt-1">Showcase a new completed construction project.</p>
                </div>
            </div>
