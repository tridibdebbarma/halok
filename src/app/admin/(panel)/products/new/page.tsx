...
export default function NewProductPage() {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        setIsSaving(true);
        try {
            // Convert specsArray to JSON object
    ...
    return (
        <div className="p-6 pb-20 max-w-5xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-[#1E3A5F]">Add New Product</h1>
                    <p className="text-slate-500 mt-1">Add a new material or product to your catalog.</p>
                </div>
            </div>
                                ...
                                <CardContent className="p-6 space-y-6">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-sm text-slate-500">Add technical details as key-value pairs.</p>
                                        </div>
                                        <Button
                                            type="button"
                                            variant="outline"
