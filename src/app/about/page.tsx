        ...
        <>
            ...
            <section className="pt-32 pb-16 md:pt-40 md:pb-24 bg-[var(--theme-primary,#1E3A5F)] text-white">
                <div className="container mx-auto px-4 text-center max-w-4xl">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white">About {company?.name || "Our Company"}</h1>
                ...
                <div className="container mx-auto px-4">
                    <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
                        <div className="space-y-6">
                            <div className="inline-block px-4 py-1.5 bg-blue-50 text-[var(--theme-accent,#2563eb)] font-semibold text-sm rounded-full mb-2">
                                Our Story
                            </div>
                            <h2 className="text-3xl md:text-4xl font-bold text-[var(--theme-primary,#1E3A5F)]">A Legacy of Building Better</h2>
                            ...
                            <div className="grid grid-cols-2 gap-6 pt-6">
                                <div className="border-l-4 border-[var(--theme-accent,#2563eb)] pl-4 py-2">
                                    <div className="text-3xl font-extrabold text-[var(--theme-primary,#1E3A5F)]">{company?.years_of_experience || 15}+</div>
                                    <div className="text-slate-500 font-medium">Years Experience</div>
                                </div>
                                <div className="border-l-4 border-[var(--theme-accent,#2563eb)] pl-4 py-2">
                                    <div className="text-3xl font-extrabold text-[var(--theme-primary,#1E3A5F)]">{company?.total_projects || 500}+</div>
                        ...
                        <div className="relative aspect-auto h-[500px] md:h-[600px] rounded-2xl overflow-hidden shadow-2xl">
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-[var(--theme-primary,#1E3A5F)]/80 via-transparent to-transparent"></div>
                            <div className="absolute bottom-8 left-8 right-8 text-white">
                                <h3 className="text-2xl font-bold mb-2 text-white">Quality First approach</h3>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                            <div className="h-14 w-14 rounded-xl bg-blue-50 flex items-center justify-center mb-6">
                                <Target className="h-7 w-7 text-[var(--theme-accent,#2563eb)]" />
                            </div>
                            <h3 className="text-2xl font-bold text-[var(--theme-primary,#1E3A5F)] mb-4">Our Mission</h3>
                        ...
                        <div className="bg-white p-10 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                            <div className="h-14 w-14 rounded-xl bg-blue-50 flex items-center justify-center mb-6">
                                <Eye className="h-7 w-7 text-[var(--theme-accent,#2563eb)]" />
                            </div>
                            <h3 className="text-2xl font-bold text-[var(--theme-primary,#1E3A5F)] mb-4">Our Vision</h3>
                            <p className="text-slate-600 leading-relaxed text-lg">
                ...
                <section className="py-20 md:py-28 bg-white">
                    <div className="container mx-auto px-4">
                        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
                            <h2 className="text-3xl md:text-5xl font-bold text-[var(--theme-primary,#1E3A5F)]">Meet Our Leaders</h2>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            {team.map((member: any) => (
                                <div key={member.id} className="group flex flex-col items-center text-center">
                                    ...
                                    <h3 className="text-xl font-bold text-[var(--theme-primary,#1E3A5F)] mb-1">{member.name}</h3>
                                    <div className="text-[var(--theme-accent,#2563eb)] font-medium mb-4">{member.role}</div>
                                    {member.bio && (
                                        <p className="text-slate-500 text-sm leading-relaxed px-4">{member.bio}</p>
                                    )}
                                    {member.linkedin_url && (
                                        <a href={member.linkedin_url} target="_blank" rel="noopener noreferrer" className="mt-4 text-slate-400 hover:text-[var(--theme-accent,#2563eb)] transition-colors p-2">
            ...
            <section className="py-20 bg-[var(--theme-primary,#1E3A5F)] text-white">
                <div className="container mx-auto px-4 text-center max-w-3xl">
                    <h2 className="text-3xl md:text-4xl font-bold mb-12 text-white">Why Choose Us?</h2>
                    <div className="grid sm:grid-cols-3 gap-8 text-center border-t border-b border-white/10 py-12">
                        <div className="space-y-4">
                            <ShieldCheck className="h-10 w-10 text-[var(--theme-accent-light,#3b82f6)] mx-auto" />
                            <h4 className="text-xl font-semibold text-white">Fully Certified</h4>
                            <p className="text-blue-100/70 text-sm">Meeting all national building and safety regulations.</p>
                        </div>
                        <div className="space-y-4">
                            <HardHat className="h-10 w-10 text-[var(--theme-accent-light,#3b82f6)] mx-auto" />
                            <h4 className="text-xl font-semibold text-white">Expert Professionals</h4>
                            <p className="text-blue-100/70 text-sm">Vetted, highly trained engineers and project managers.</p>
                        </div>
                        <div className="space-y-4">
                            <Clock className="h-10 w-10 text-[var(--theme-accent-light,#3b82f6)] mx-auto" />
                            <h4 className="text-xl font-semibold text-white">On-Time Delivery</h4>
